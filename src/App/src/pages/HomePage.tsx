    ...
    useEffect(() => {
        const initTeam = async () => {
            ...
            try {
                ...
                // Attaching the known team is enough for the associate to ask.
                // Workflow construction continues without becoming a surface
                // phase; no signal reports it (ADR-023).
                void (async () => {
