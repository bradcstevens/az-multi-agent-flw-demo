  ...
  static convertTeamConfiguration(teamConfigBE: TeamConfigurationBE | null): TeamConfig | null {
    ...
    return {
      ...
      agents: teamConfigBE.agents.map((agentBE: TeamAgentBE): Agent => ({
        ...
        use_toolbox: agentBE.use_toolbox,
        toolbox_filter: agentBE.toolbox_filter,
        use_knowledge_base: agentBE.use_knowledge_base,
        knowledge_base_name: agentBE.knowledge_base_name,
        use_file_search: agentBE.use_file_search,
        vector_store_name: agentBE.vector_store_name,
        user_responses: agentBE.user_responses,
        temperature: agentBE.temperature,
