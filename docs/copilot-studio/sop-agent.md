...
| `--provision` | Creates or converges the agent, its three authored components and the ten SOP documents. Idempotent by schema name. |
...
greets, answers in numbered steps with a named source, and refuses the out-of-corpus question.
