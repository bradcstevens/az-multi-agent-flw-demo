...
deploying — [ADR-044](ADR/044-the-feedback-loops-table-is-what-the-gate-runs.md), and
...
([ADR-044](ADR/044-the-feedback-loops-table-is-what-the-gate-runs.md)). What runs in CI is
