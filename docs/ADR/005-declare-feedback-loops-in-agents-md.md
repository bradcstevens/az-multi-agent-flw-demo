...
**Amended by [ADR-045](./045-the-feedback-loops-virtualenv-is-shared-across-worktrees.md):** the
...
**Amended by [ADR-046](./046-the-feedback-loops-table-is-what-the-gate-runs.md):** the table has
...
- A cold worktree pays a one-off dependency install (roughly three to four minutes) on its first
  ...
  [ADR-045](./045-the-feedback-loops-virtualenv-is-shared-across-worktrees.md):** this consequence
